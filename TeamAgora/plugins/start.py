...
from TeamAgora import Telegram, YouTube, app
from TeamAgora.misc import SUDOERS, _boot_
from TeamAgora.plugins.playlist import del_plist_msg
from TeamAgora.plugins.sudoers import sudoers_list
from TeamAgora.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from TeamAgora.utils.formatters import get_readable_time
from TeamAgora.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAx0Cc4SelwACQPtkJRqt1QYEjbVluQLsjxTu9EQR7wACzQYAAiJ3OVc7jlrPQwbeBy8E")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/agoraworld) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
|| ᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ [ᴀʟᴏɴᴇ❣️](https://t.me/mr_agora) 🥀 ||
