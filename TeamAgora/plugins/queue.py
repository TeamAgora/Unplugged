...
from TeamAgora.utils import (Anonbin, get_channeplayCB,
                              seconds_to_min)
from TeamAgora.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from TeamAgora.utils.decorators.language import language, languageCB
from TeamAgora.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://te.legra.ph/file/fca643c6aceb4a530124f.jpg",
        caption=_["queue_1"],
    )
